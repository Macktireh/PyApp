...
class AppUI():
    ...
    def Container_1(self, win, title):
        ...
        self.VarLabelPath_1.set(f"Commencer par importer le fichier {title}")
    ...
    def Container_2(self, win, title):
        ...
        self.VarLabelPath_2.set(f"Commencer par importer le fichier {title}")
    ...
    def preview_data(self, path, df):
        ...
        self.preview.iconbitmap("static/img/TotalEnergies.ico")
        self.preview.geometry("800x450+15+15")
    ...
    def Excel_1(self):
        self.typefile = "Excel"
        self.PathImport1, self.df1 = self.ImportData()
        self.VarLabelPath_1.set(self.PathImport1)
    def Excel_2(self):
        self.typefile = "Excel"
        self.PathImport2, self.df2 = self.ImportData()
        self.VarLabelPath_2.set(self.PathImport2)
        
    def ViewData_1(self):
        self.preview_data(self.PathImport1, self.df1)
    def ViewData_2(self):
        self.preview_data(self.PathImport2, self.df2)

    def browse_button(self):
        self.PathExport = filedialog.askdirectory()
        self.PathExportFinal = self.PathExport + f'/KPI-SIS-AFRIQUE-{self.today}.xlsx'
        print(self.PathExportFinal)
        
    def runing(self):
        m = EuroShare(self.df1, self.df2, self.PathExportFinal)
        m.reduce()
